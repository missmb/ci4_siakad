        ...
        <div class="col-sm-8 m-auto">
            <div class="card card-success">
                ...
                <div class="card-body">
                    ...
                    <?php } ?>
                    <?= form_open_multipart('student/insert'); ?>
                    <div class="form-group">
                        <label>NIM</label>
                        <input class="form-control" type="number" name="nim" placeholder="nim">
                    </div>
                    <div class="form-group">
                    ...
                    <div class="row">
                        <div class="col-sm-6 text-center">
                            <div class="form-group">
                                <img src="<?= base_url('img/student/default.jpg') ?>" id="cover_load" width="130px" height="130px">
                            </div>
                        </div>
                        <div class="col-sm-6">
                            <div class="form-group">
